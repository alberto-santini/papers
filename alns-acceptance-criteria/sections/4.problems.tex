...
For more information the reader is referred to \citet{irnich2014family} and \citet{laporte2014heuristics}.
...
For more information on this problem, see \citet{uchoa2008robust}.
...
\rev{More information about this problem can be found in the seminal paper by \citet{lawler1963quadratic}.}
\rev{For works on metaheuristics for the QAP see, e.g., \citet{stutzle2006iterated,james2009multistart}.}
