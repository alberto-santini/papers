...
\rev{
  ...
  In other contexts, this number may be limited, either because the operators in the ALNS are time consuming themselves \citep{gullhav2017alns}, because other time consuming calculations are made between ALNS iterations \citep{schmid2014}, or because the ALNS is part of a larger framework and has to run fast \citep{parragh2013lnscolumn}.
  } 

\secrev{
  \citet{BuGeHyKeOcOzQu13} considered ALNS to be a form of a hyper-heuristics.
  Different acceptance criteria have been tested within the framework of hyper-heuristics.
  As an example, \citet{BuOzKo06} compared RW, HC, a version of HC with strict improvement required, GD, and a version of SA.
  ...
  The narrative literature review of \citep{BuGeHyKeOcOzQu13}, although summarising several other studies with comparisons of acceptance criteria, also did not provide any conclusions about the relative merit of the different criteria.
}
...
\rev{
  ...
  To the authors knowledge, such a concept has not been explored within the ALNS framework, but a similar idea can be found in skewed variable neighbourhood search \citep{hansen2001vns}.
}
