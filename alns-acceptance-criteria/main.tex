...
\begin{document}
  ...
  \input{sections/2.alns.tex}
  \input{sections/3.acceptance_criteria.tex}
  \input{sections/4.problems.tex}
  \input{sections/5.alns_applied.tex}
  \input{sections/6.parameter_tuning.tex}
